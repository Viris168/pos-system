...
public class product extends javax.swing.JPanel {
    ...
    public void setimage(){
        ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("image_admin/search.jpeg"));       
                   
        Image img = icon.getImage().getScaledInstance(jLabelSearchlogo.getWidth(), jLabelSearchlogo.getHeight(), Image.SCALE_SMOOTH);
                    jLabelSearchlogo.setIcon(new ImageIcon(img)); 
    }
